...
# Classes for all the Buttons in the Scientific Calculator.
...
# the code for NUMBER PAD in Calculator.
...
# the code for Button of Standard Calulator.
...
# the code for Buttons of Scientific Calulator.
